...
/**
 * Servlet implementation class AddLotteryController
 */
public class AddLotteryController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddLotteryController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
        	RequestDispatcher rd = request.getRequestDispatcher("admin/addLottery.jsp");
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(tinhDo.equals("hn")) {
    		tinhDo = "Ha Noi";
    	}else if(tinhDo.equals("hcm")) {
    		tinhDo = "Tp Ho Chi Minh";
    	}else if(tinhDo.equals("dn")) {
    		tinhDo = "Da Nang";
    	}else {
    		tinhDo = "";
    	}
		...
		String kq = "failed";
		kq = modifyDAO.createLottery(arr);
        if(kq.equals("succes")) {
        	request.setAttribute("showToast", "Execution add lottery successful.");
        } else {
        	request.setAttribute("showToast", "Execution add lottery failed.");
        }
        try{
